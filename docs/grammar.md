...
상수의 이름에는 한글 자모, 한글 음절, 로마자, 숫자, 언더스코어(`_`)만 허용됩니다. 그리고 상수의 이름은 숫자로 시작할 수 없습니다.
...
- 함수의 이름에는 한글 음절, 언더스코어(`_`)만 허용됩니다.
- 조사에는 한글 음절, 언더스코어(`_`)만 허용됩니다.
...
- 구조체의 이름에는 한글 음절, 언더스코어(`_`)만 허용됩니다.
- 필드의 이름에는 한글 음절, 언더스코어(`_`)만 허용됩니다.
